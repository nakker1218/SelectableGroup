...
import kotlinx.android.synthetic.main.view_radio_cell.view.*
 ...
 * @author nakker
 */
class RadioCellView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    : ConstraintLayout(context, attrs, defStyleAttr), SelectableGroup.Selectable {

    override val compoundButton: CompoundButton

    init {
        LayoutInflater.from(context).inflate(R.layout.view_radio_cell, this, true)
        compoundButton = radio_button
